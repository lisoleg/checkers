...
var (
	pattern_Query_Token_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"alice", "checkers", "token", "tokens", "denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Tokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"alice", "checkers", "token", "tokens"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Fees_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"alice", "checkers", "token", "tokens", "symbol", "fees"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"alice", "checkers", "token", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TotalBurn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"alice", "checkers", "token", "total_burn"}, "", runtime.AssumeColonVerbOpt(true)))
)
